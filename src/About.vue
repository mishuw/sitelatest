    ...
    <div class="relative">
        <div class="flex flex-col lg:flex-row justify-between w-full items-center h-full">
            <div class="flex flex-col lg:justify-start justify-center items-center lg:items-start mt-5 lg:mt-0 w-full">
                ...
                <span class="ml-2 text-gray px-2 py-1 font-normal rounded-md text-sm discord-lg" onclick="location.href='https://discord.com/users/906634054311481364'"><i class="fa-brands fa-discord"></i></span>
            </div>
        </div>
    </div>
</div>
